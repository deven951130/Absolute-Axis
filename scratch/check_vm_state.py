...
print("--- Checking axis.db ---")
out, err = run_cmd_on_vm("ls -la /home/sparkle/Absolute-Axis/axis.db")
print(out)

print("\n--- Checking nas directory ---")
out, err = run_cmd_on_vm("ls -la /home/sparkle/Absolute-Axis/nas")
print(out)

print("\n--- Checking for any error logs in app ---")
out, err = run_cmd_on_vm("docker logs axis-server --tail 50")
print(out)
