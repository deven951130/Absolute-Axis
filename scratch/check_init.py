...
print("--- Checking users via Python on VM ---")
python_cmd = "python3 -c \"import sqlite3; conn = sqlite3.connect('/home/sparkle/Absolute-Axis/axis.db'); cur = conn.cursor(); cur.execute('SELECT username FROM users'); print(cur.fetchall())\""
out, err = run_cmd_on_vm(python_cmd)
print(out)
if err: print("ERR:", err)

print("\n--- Checking axis-server logs ---")
out, err = run_cmd_on_vm("docker logs axis-server")
print(out)
