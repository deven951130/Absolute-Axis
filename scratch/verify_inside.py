...
print("--- Checking users INSIDE container ---")
docker_cmd = "docker exec axis-server python3 -c \"import sqlite3; conn = sqlite3.connect('/app/axis.db'); cur = conn.cursor(); cur.execute('SELECT username FROM users'); print(cur.fetchall())\""
