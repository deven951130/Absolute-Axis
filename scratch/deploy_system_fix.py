...
print("--- Updating system.py on VM ---")
with open('e:/absolute axis/app/routers/system.py', 'r', encoding='utf-8') as f:
    content = f.read()

# Using cat with EOF to write content
run_cmd_on_vm(f"cat <<'EOF' > /home/sparkle/Absolute-Axis/app/routers/system.py\n{content}\nEOF")

print("--- Restarting axis-server ---")
run_cmd_on_vm("docker restart axis-server")
print("Done")
