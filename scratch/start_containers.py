...
print("--- Checking .env on VM ---")
out, err = run_cmd_on_vm("ls -la /home/sparkle/Absolute-Axis")
print(out)

print("\n--- Checking docker-compose version ---")
out, err = run_cmd_on_vm("docker compose version")
print(out)
if err: print("ERR:", err)

print("\n--- Attempting to start containers ---")
# Need to be in the directory
out, err = run_cmd_on_vm("cd /home/sparkle/Absolute-Axis && docker compose up -d")
print(out)
if err: print("ERR:", err)
