...
print("--- Axis Server Logs ---")
out, err = run_cmd_on_vm("docker logs axis-server")
print(out)

print("\n--- Testing local connectivity to app ---")
out, err = run_cmd_on_vm("curl -I http://localhost:8000")
print(out)
if err: print("ERR:", err)

print("\n--- Checking cloudflared config (if any) ---")
out, err = run_cmd_on_vm("ls -la /home/sparkle/.cloudflared")
print(out)
